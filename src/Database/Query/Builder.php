 ...
 *
 * https://github.com/laravel/framework/blob/5.4/src/Illuminate/Database/Query/Builder.php
 *
...
use ZhiYangLee\Lego\Database\Connectors\Connector;
...
use ZhiYangLee\Lego\Database\ConnectionInterface;
use ZhiYangLee\Lego\Database\Query\Grammars\Grammar;
...
class Builder
{
     ...
     *
     * @var \ZhiYangLee\Lego\Database\Connectors\Connector
     */
     ...
     * @return \ZhiYangLee\Lego\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\ZhiYangLee\Lego\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \ZhiYangLee\Lego\Database\Query\Builder|static
     *
     ...
     *
     * @param  \ZhiYangLee\Lego\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \ZhiYangLee\Lego\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \ZhiYangLee\Lego\Database\Query\Builder|static
     */
