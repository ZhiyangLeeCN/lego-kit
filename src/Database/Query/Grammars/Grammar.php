<?php namespace ZhiYangLee\Lego\Database\Query\Grammars;

/**
 * copy form Laravel Database
 *
 * https://github.com/laravel/framework/blob/5.4/src/Illuminate/Database/Query/Grammars/Grammar.php
 *
...
use ZhiYangLee\Lego\Database\AbstractGrammar;
